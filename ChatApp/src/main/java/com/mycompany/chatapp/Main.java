...
public class Main extends javax.swing.JFrame implements Runnable {
    ...
    private String currentChannel;//il va falloir garder en memoire tous les chats recus, par channel
    ...
    private void initComponents() {
        ...
        closeButton.setFont(new java.awt.Font("Segoe UI Light", 0, 48)); // NOI18N
